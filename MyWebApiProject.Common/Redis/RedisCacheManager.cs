...
namespace MyWebApiProject.Common.Redis
{
   public class RedisCacheManager : IRedisCacheManager
    {
        ...
        public TEntity Get<TEntity>(string key)
        {
            ...
            if (value.HasValue)
            {
                ...
                return SerializeUtil.ByteArrayDeserialize<TEntity>(value);
            }
            else
            {
        ...
        public void Set(string key, object value, TimeSpan cacheTime)
        {
            if (value != null)
            {
                ...
                redisConnection.GetDatabase().StringSet(key, SerializeUtil.SerializeToByteArray(value), cacheTime);
            }
        }
